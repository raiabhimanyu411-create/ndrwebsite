      ...
      <div className="container">
        ...
        <ul className={styles.list}>
          ...
          <li>
            ...
            <a href="#" className={styles.link}> NDR Data Sharing Rates </a>
          </li>

          <li>
            Please refer to the refund and cancellation policy for the data ordered through NDR portal  
            <a href="#" className={styles.link}> Refund & Cancellation Policy </a>
          </li>
          ...
          <li>
            ...
            <a href="#" className={styles.link}> E&P Data Policy </a>
          </li>
          ...
          <li>
            ...
            <a href="#" className={styles.link}> Download Confidentiality Agreement </a>
          </li>
          ...
          <li>
            ...
            <a href="#" className={styles.link}> Cyber-Security Handbook – ENGLISH </a>  
            &  
            <a href="#" className={styles.link}> Cyber-Security Handbook – HINDI </a>
          </li>
          ...
          <li>
            ...
            <a href="#" className={styles.link}> Revised Data Submission Guidelines </a>
          </li>
          ...
          <li>
           Old Guidelines for submission of E&P data of Nomination Fields by National Oil Companies (NOCs) to National Data Repository (NDR):  
            <a href="#" className={styles.link}> Old Data Submission Guidelines </a>
          </li>
